...
# <span class="image image-doc-icon">![Check if file is locked transform Icon](../assets/images/transforms/icons/filelocked.svg)</span> Check if file is locked
...
<div class="sectionbody">
<div class="paragraph">
<p>The Check If A File Is Locked transform tries to determine if a file is locked by another process by trying to move the file to itself.</p>
</div>
</div>
</div>
</div></td>
